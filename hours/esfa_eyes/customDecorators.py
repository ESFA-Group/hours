...
def esfa_eyes_access_required(
    ...
    actual_decorator = user_passes_test(
        lambda u: u.is_active and (u.is_superuser or u.is_FinancialManager or u.is_InternationalFinanceManager or u.is_InternationalSalesManager or u.is_ProductionManager),
        login_url=login_url,
